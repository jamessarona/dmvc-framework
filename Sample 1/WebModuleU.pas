...
type
  TMyWebModuleU = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TMyWebModuleU;
...
procedure TMyWebModuleU.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TMyControllerU);
...
procedure TMyWebModuleU.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
