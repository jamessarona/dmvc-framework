...
type
  TRenderWebModule = class(TWebModule)
...
var
  WebModuleClass: TComponentClass = TRenderWebModule;
...
procedure TRenderWebModule.WebModuleCreate(Sender: TObject);
begin
  ...
  FMVC.AddController(TRenderSampleController);
...
procedure TRenderWebModule.WebModuleDestroy(Sender: TObject);
begin
  FMVC.Free;
end;
